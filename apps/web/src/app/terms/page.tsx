...
export const metadata = {
    title: 'Terms of Service - NoteTaker',
    description: 'Terms of Service and usage conditions for NoteTaker AI.',
};
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 32px', color: '#e5e5e5', lineHeight: '1.7' }}>
            ...
            <section style={{ marginBottom: '32px' }}>
                ...
                <p style={{ marginBottom: '16px' }}>
                    By accessing or using the NoteTaker website (NoteTakerai.com) and services, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, then you may not access the Service.
                </p>
            </section>
            ...
            <section style={{ marginBottom: '32px' }}>
                ...
                <p style={{ marginBottom: '16px' }}>
                    NoteTaker provides AI-powered meeting transcription and summarization tools. You agree to use the Service only for lawful purposes and in accordance with these Terms. You are prohibited from:
                </p>
            ...
            <section style={{ marginBottom: '32px' }}>
                ...
                <p style={{ marginBottom: '16px' }}>
                    You retain all rights and ownership to the audio files, transcripts, and summaries generated through your use of the Service ("Your Content"). By using the Service, you grant NoteTaker a limited, secure license to process Your Content solely for the purpose of providing the transcription and summarization features to you. We do not sell your data or use it to train public AI models.
                </p>
            </section>
            ...
            <section style={{ marginBottom: '32px' }}>
                ...
                <p style={{ marginBottom: '16px' }}>
                    Our Service may integrate with third-party services (e.g., Google Calendar, Zoom, OpenAI). NoteTaker is not responsible for the content, privacy policies, or practices of any third-party web sites or services. You acknowledge and agree that NoteTaker shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of any such third-party services.
                </p>
            </section>
            ...
            <section>
                ...
                <p>
                    If you have any questions about these Terms, please contact us at support@NoteTakerai.com.
                </p>
            </section>
        </div>
    );
